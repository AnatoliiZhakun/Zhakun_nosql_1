...
print("=== Частина 3. Завдання 1. Топ-10 виконавців за середньою популярністю ===");

const topArtistsByAvgPopularity = db.tracks.aggregate([
  {
    $unwind: "$artists"
  },
  {
...
topArtistsByAvgPopularity.forEach(printjson);
...
moodDistribution.forEach(printjson);
